...
import { Steps, Box, Button, Collapsible, VStack, HStack, Text, Icon, Link as ChakraLink } from "@chakra-ui/react";
import { 
  FiChevronDown,
  FiChevronUp,
  FiInfo,
...
const WhatIsEIPsInsightDropdown: React.FC = () => {
  const { open, onToggle } = useDisclosure({ defaultIsOpen: false }); // Initially collapsed
            ...
            <VStack gap={4} align="stretch">
                ...
                <NextLink href="/about" passHref>
                  <ChakraLink _hover={{ textDecoration: 'none' }}>
                    <Button
                      ...
                      px={4}
                      py={2}
                      transition="all 0.2s">Learn More
              ...
              {!loading && (
                ...
                >
                  ...
                  {/* Main Stats Row */}
                  <HStack gap={0} justify="space-between" mb={3}>
