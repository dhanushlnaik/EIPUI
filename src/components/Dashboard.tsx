...
import { Steps, Box, Button, Heading, Icon, Text, useMediaQuery, Link as LI, Stack, Flex } from "@chakra-ui/react";
                        ...
                        >
                          <Stack direction={"column"} gap={4}>
                            ...
                            <Box 
                              ...
                              maxWidth="700px"
                            >
                              <Stack direction={"row"} gap={"4"} flexWrap="nowrap" alignItems="center" mb={3}>
                              <Box
                                as={motion.div}
                              ...
                              >
                                <NextLink href={"/home#1"}>
                                  <Button
                                    ...
                                    borderRadius="lg"
                                    transition="all 0.2s ease">Dashboard
                              ...
                              >
                                ...
                                >
                                  <Button
                                    ...
                                    boxShadow="0 4px 12px -4px rgba(48, 160, 224, 0.3)"
                                    borderRadius="lg"
                                    transition="all 0.2s ease">{monthName}{year}Insight
                                                                      <BsGraphUp /></Button>
                                </NextLink>
                              </Box>
                              ...
                              >
                                <NextLink href={"/all"}>
                                  <Button
                                    ...
                                    boxShadow="0 4px 12px -4px rgba(48, 160, 224, 0.3)"
                                    borderRadius="lg"
                                    transition="all 0.2s ease">Explore EIPs
                                                                      <BookOpen/></Button>
                                </NextLink>
                              </Box>
