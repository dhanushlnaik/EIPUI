...
;
import { Steps, Box, Container, Heading, Text, Flex, Icon, Badge, Avatar, VStack, HStack, Image as ChakraImage } from "@chakra-ui/react";
      ...
      <Box minH="100vh" bgGradient={bgGradient} w="100%" overflowX="hidden">
        <Container maxW="full" py={8} px={{ base: 2, sm: 4, md: 6 }}>
          ...
          >
            ...
            {/* Meta Info Bar */}
            <HStack gap={4} mb={6} fontSize="sm" color={mutedColor} flexWrap="wrap">
            ...
            <Box mb={8} pb={8} borderBottom="2px" borderColor={dividerColor}>
              <Flex align="center" gap={4} mb={4}>
                {frontmatter.authorAvatar || frontmatter.avatar ? (
                  <Avatar.Root size="lg" border="4px" borderColor="blue.500" shadow="lg"><Avatar.Fallback name={frontmatter.author} /><Avatar.Image src={frontmatter.authorAvatar || frontmatter.avatar} /></Avatar.Root>
                ) : (
                  <Avatar.Root
                    size="lg"
                    ...
                    color="white"
                    fontWeight="bold"
                    shadow="lg"><Avatar.Fallback name={frontmatter.author} /></Avatar.Root>
                )}
                <Box flex="1">
                  ...
                  {(frontmatter.authorBio || frontmatter.role) && (
                    <Text fontSize="sm" color={mutedColor} mt={1} lineClamp={2}>
                      {frontmatter.authorBio || frontmatter.role}
                    </Text>
                  )}
                </Box>
