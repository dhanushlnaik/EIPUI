...
interface EditorReviewerRepoGridProps {
  editorsData: EditorData[];
  reviewersData: EditorData[];
}

const EditorReviewerRepoGrid: React.FC<EditorReviewerRepoGridProps> = ({
  editorsData,
  reviewersData,
}) => {
  ...
  const displayedEditors = showAllEditors ? editorsData : editorsData.slice(0, 6);
  const displayedReviewers = showAllReviewers ? reviewersData : reviewersData.slice(0, 6);
            ...
            {editorsData.length > 6 && (
              <Flex justify="center">
                <Button
                  ...
                  size="md"
                >
                  {showAllEditors ? 'Show Less' : `See More (${editorsData.length - 6} more)`}
                </Button>
              </Flex>
            )}
          </>
            ...
            {reviewersData.length > 6 && (
              <Flex justify="center">
                <Button
                  ...
                  size="md"
                >
                  {showAllReviewers ? 'Show Less' : `See More (${reviewersData.length - 6} more)`}
                </Button>
              </Flex>
            )}
          </>
...
export default EditorReviewerRepoGrid;
