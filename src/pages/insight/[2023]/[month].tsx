      ...
      <AllLayout>
        {isLoading ? ( // Check if the data is still loading
          ...
          <>
            ...
            >
              <Box
                paddingBottom={{ lg: "3", sm: "3", base: "3" }}
              ...
              >
                ...
                <Text
                  fontSize="3xl" fontWeight="bold" color="#30A0E0" mt={8}
                >
                   <div className="py-8" id="draft-vs-final">
                  <div > 
                    Draft vs Final{" "}
                  <CopyLink
