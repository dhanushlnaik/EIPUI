...
/>
            ...
            <br/>
                ...
                <Link
                  ...
                  target='_blank'
                  rel='noopener noreferrer'>Vitalik Buterin (@vbuterin)</Link>, 
                <Link
                  color={linkColor}
                  href="https://x.com/_samwilsn_"
                  target='_blank'
                  rel='noopener noreferrer'>Sam Wilson (@SamWilsn)</Link>, 
                <Link
                  color="blue.300"
                  href="https://x.com/adietrichs"
                  target='_blank'
                  rel='noopener noreferrer'>Ansgar Dietrichs (@adietrichs)</Link>, 
                <Link
                  color="blue.300"
                  href="https://x.com/lightclients"
                  target='_blank'
                  rel='noopener noreferrer'>lightclient (@lightclient)</Link> <br />
                <br/>
        ...
        <Box w="100%" my={12}>
          {/*<PlaceYourAdCard /> */}
            ...
            <Text fontSize={{ base: "md", sm: "md", md: "xl" }}  mt={4} textAlign="justify">
                ...
                <Link
                  color="blue.300"
                  href="https://youtu.be/RlC0vTKzL2w?si=YGmheazLHakmxfky"
                  target='_blank'
                  rel='noopener noreferrer'>externally owned accounts (EOAs)</Link> 
                ...
                <Link
                  ...
                  target='_blank'
                  rel='noopener noreferrer'>account abstraction</Link> 
                {" "}improvements. <br />
                
                ðŸ”— <b>
                <Link
                  color="blue.300"
                  href="https://eipsinsight.com/eips/eip-7702"
                  target='_blank'
                  rel='noopener noreferrer'>Read the Full EIP</Link>
                </b>
            </Text>
  ...
  <List.Root as='ul'>
    <List.Item>
      <Link
        color="blue.300"
        href="https://eipsinsight.com/eips/eip-7727"
        target='_blank'
  ...
  <Text fontSize={{ base: "sm", sm: "md", md: "xl" }}  mt={2}>
    ðŸ”— <Link
    color="blue.300"
    href="https://eipsinsight.com/eips/"
    target='_blank'
    rel='noopener noreferrer'>Explore All EIPs</Link>
  </Text>
  ...
  <Text fontSize={{ base: "sm", sm: "md", md: "xl" }}   mt={2}>
    ...
    <Link
      color="blue.300"
      href="https://ethereum-magicians.org/t/pectra-retrospective/22637"
      target='_blank'
      rel='noopener noreferrer'>
  ...
  <List.Root as='ul'>
    <List.Item>
      <Link
        ...
        color="blue.300"
        href="https://github.com/ethcatherders/EIPIP/issues/376"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethcatherders/EIPIP/issues/374"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethcatherders/EIPIP/issues/373"
        target='_blank'
        rel='noopener noreferrer'>
  ...
  <List.Root as='ul'>
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethereum/pm/issues/1278"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethereum/pm/issues/1263"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethereum/pm/issues/1216"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethereum/pm/issues/1274"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethereum/pm/issues/1279"
        target='_blank'
        rel='noopener noreferrer'>
    ...
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://github.com/ethereum/pm/issues/1271"
        target='_blank'
        rel='noopener noreferrer'>
  ...
  <List.Root as='ul'>
    <List.Item>
      <Link
        ...
        target='_blank'
        rel='noopener noreferrer'>ETH Oxford hackathon</Link> - Feb 7-9
    </List.Item>
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        ...
        target='_blank'
        rel='noopener noreferrer'>ETHiopia conference & hackathon</Link> - Feb 10-16
    </List.Item>
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        ...
        target='_blank'
        rel='noopener noreferrer'>ETHDenver</Link> - Feb 23 â€“ Mar 2
    </List.Item>
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        color="blue.300"
        href="https://www.ethpondy.xyz/"
        target='_blank'
        rel='noopener noreferrer'>ETH Pondy (Puducherry) hackathon</Link> - Mar 28-30
    </List.Item>
    <List.Item>
      <Link
        fontSize={{ base: "sm", sm: "md", md: "xl" }}
        ...
        target='_blank'
        rel='noopener noreferrer'>ETH Bucharest hackathon & conference</Link> - Apr 2-5
    </List.Item>
  </List.Root>

  <Text fontSize={{ base: "sm", sm: "md", md: "xl" }}   mt={6} fontWeight="bold">ðŸ“° Latest Blockchain News</Text>
  <List.Root as='ul'>
    <List.Item fontSize={{ base: "sm", sm: "md", md: "xl" }}>
      ...
      <Link
        color="blue.300"
        href="https://etherworld.co/2025/02/03/india-to-change-crypto-strategy-as-global-trends-shift/"
        target='_blank'
        rel='noopener noreferrer'> [EtherWorld.co]</Link>
    </List.Item>
    <List.Item fontSize={{ base: "sm", sm: "md", md: "xl" }}>
    ...
    <List.Item fontSize={{ base: "sm", sm: "md", md: "xl" }}>
      ...
      <Link
        color="blue.300"
        href="https://www.reuters.com/technology/brazils-galipolo-sees-surge-crypto-use-says-90-flow-tied-stablecoins-2025-02-06/"
        target='_blank'
        rel='noopener noreferrer'> [Reuters.com]</Link>
    </List.Item>
    <List.Item fontSize={{ base: "sm", sm: "md", md: "xl" }}>
      <b>BlackRock's Bitcoin ETP in Europe</b> - Investment firm launching Bitcoin ETP in Switzerland. 
      <Link
        color="blue.300"
        href="https://www.reuters.com/technology/blackrock-prepares-launch-bitcoin-exchange-traded-product-europe-source-says-2025-02-05/"
        target='_blank'
        rel='noopener noreferrer'> [Reuters.com]</Link>
    </List.Item>
    <List.Item fontSize={{ base: "sm", sm: "md", md: "xl" }}>
      ...
      <Link
        color="blue.300"
        href="https://www.fnlondon.com/articles/crypto-exchanges-eye-eu-expansion-uk-plays-a-catch-up-game-f012b451"
        target='_blank'
        rel='noopener noreferrer'> [Reuters.com]</Link>
    </List.Item>
  </List.Root>
  ...
  <Text mt={6} fontSize={{ base: "sm", sm: "md", md: "xl" }}>
    ...
    <Link
      color="blue.300"
      href="https://x.com/TeamAvarch"
      target='_blank'
      rel='noopener noreferrer'> EIPsInsight</Link> for the latest EIP Updates.
  </Text>
