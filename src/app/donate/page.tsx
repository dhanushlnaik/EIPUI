...
import { Steps, Flex, Icon, Heading, Text, Link as ChakraLink, HStack, Badge, Grid, GridItem, Box, Tag, IconButton, Collapsible, Stack, Button, Container, VStack, SimpleGrid, InputGroup, Input, Image, Separator, useClipboard } from "@chakra-ui/react";
...
const DonateHero: React.FC = () => (
  ...
  >
    ...
    <HStack gap={2}>
      <Badge px={2} py={0.5} colorPalette="pink" fontWeight="semibold" fontSize="sm">
        <Icon as={FaUsers} mr={1} /> COMMUNITY DRIVEN
      </Badge>
      <Badge px={2} py={0.5} colorPalette="blue" fontWeight="semibold" fontSize="sm">
  ...
  return (
    <Box w="full">
      ...
      <HStack gap={3} align="center" wrap="wrap">
        {tierLegend.map((t) => (
          <Tooltip key={t.label} content={t.tooltip} showArrow positioning={{
            placement: "top"
          }}>
            <Tag.Root
              size="md"
    ...
    >
      <Flex align="center" justify="space-between" mb={2} className="card-header">
        ...
        <IconButton
          ...
          className="toggle-arrow">{open ? <LuChevronUp /> : <LuChevronDown />}</IconButton>
      </Flex>
      <Collapsible.Root open={open} className="card-body">
        <Collapsible.Content>
          <Stack gap={4} align="start" mt={4}>
              ...
              <Box key={idx} py={2} px={0} w="full" className="grant-round">
                <Box>
                  <HStack justify="space-between" w="full" align="start">
                    ...
                    <Badge colorPalette="blue" px={2} py={0.5} borderRadius="full" fontSize="xs" className="grant-year">{grant.year}</Badge>
                  </HStack>
                  ...
                  {grant.tags && (
                    <HStack gap={2} mt={2} className="grant-tags">
                      {grant.tags.map((tag, i) => (
                        <Tag.Root key={i} colorPalette="blue" size="sm" borderRadius="full" px={2} py={0.5}>{tag}</Tag.Root>
                      ))}
                    </HStack>
                  )}
                  {grant.link && (
                    <Box mt={3}>
                      <ChakraLink
                        ...
                        <Button as="span" size="sm" variant="outline" colorPalette="blue" rounded="md">View Details</Button>
                      </ChakraLink>
                    </Box>
                  )}
                </Box>
      ...
      >
        <Container maxW="full" position="relative" zIndex={1}>
          <VStack gap={1} textAlign="center">
            ...
            <HStack gap={3} pt={2}>
              <Badge colorPalette="pink" px={4} py={2} borderRadius="full" fontSize="sm" fontWeight="bold">
                <Icon as={FaUsers} mr={2} />
                Community Driven
              </Badge>
              <Badge colorPalette="blue" px={4} py={2} borderRadius="full" fontSize="sm" fontWeight="bold">
                        ...
                        <VStack gap={3} align="stretch">
                          ...
                          <Box>
                            ...
                            <SimpleGrid columns={{ base: 2, md: 4 }} gap={3}>
                              {networks.map((net) => (
                                <Tooltip key={net.name} content={net.tip} showArrow>
                                  <Button
                                    size="md"
                                    rounded="xl"
                                    ...
                                    transition="all 0.2s"><Icon as={net.icon} />{net.name}</Button>
                                </Tooltip>
                              ))}
                            </SimpleGrid>
                          </Box>
                          <Box>
                            ...
                            <InputGroup size="lg" borderRadius="xl" boxShadow="sm">
                              ...
                              <InputRightElement width="4.5rem">
                                <Tooltip content={hasCopied ? 'Copied!' : 'Copy address'} showArrow>
                                  <IconButton
                                    ...
                                    transition="all 0.2s"><FaRegCopy /></IconButton>
                                </Tooltip>
                              </InputRightElement>
                            </InputGroup>
                      ...
                      >
                        <VStack gap={3} textAlign="center">
                          ...
                          <VStack gap={2}>
                            ...
                            <Badge colorPalette="blue" px={3} py={1} borderRadius="full" fontSize="sm">
                              {selectedNetwork}
                            </Badge>
                          </VStack>
                        </VStack>
